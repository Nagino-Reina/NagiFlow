...
const light = {
  ...
  colors: {
    ...
    'surface-container-low': '#F6F3FB', 'on-surface-container-low': '#1B1B21',
    'surface-container': '#F0EDF7', 'on-surface-container': '#1B1B21',
    'surface-container-high': '#EAE7F2', 'on-surface-container-high': '#1B1B21',
...
const dark = {
  ...
  colors: {
    ...
    'surface-container-low': '#1B1B21', 'on-surface-container-low': '#E5E1E9',
    'surface-container': '#1F1F25', 'on-surface-container': '#E5E1E9',
    'surface-container-high': '#2A2930', 'on-surface-container-high': '#E5E1E9',
